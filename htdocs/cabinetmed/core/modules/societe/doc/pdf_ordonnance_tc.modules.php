<?php
	...
	************************************************/
	...
	/************************************************
	* 	\file		../cabinetmed/core/modules/societe/doc/pdf_ordonnance_tc.modules.php
	* 	\ingroup	InfraS
	* 	\brief		Class file for prescription PDF
	************************************************/
	...
	************************************************/
	class pdf_ordonnance_tc extends CommonDocGenerator
	{
		var $db;
		var $name;
		var $description;
		...
		********************************************/
		public function __construct($db)
		{
			...
			$this->name							= $langs->trans('PrescriptionPDFName');
			$this->description					= $langs->trans('PrescriptionPDFDescription');
